...
<div class="container-fluid">
  ...
  <a class="navbar-brand" href="/"><h3 class="text-color"><i>Mess Food Ordering</i></h3></a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="resources/images/phonee.png" style="width:27px;" alt="img">+91 7447621759/ +91 7447621759<br>
                <img src="resources/images/emaill.png" style="width:29px;" alt="img">sanjivanibodke90@gmail.com
            </b>
        </p>
        </div>
      </div>
